...
struct DeflationStream {
    ...
    DeflationStream(CompressOptions compressOptions) {
        ...
        isInitialized = deflateInit2(&deflationStream, Z_DEFAULT_COMPRESSION, Z_DEFLATED, windowBits, memLevel, Z_DEFAULT_STRATEGY) == Z_OK;
    }
...
struct InflationStream {
    ...
    InflationStream(CompressOptions compressOptions) {
        ...
        isInitialized = inflateInit2(&inflationStream, -(compressOptions >> 8)) == Z_OK;
    }
